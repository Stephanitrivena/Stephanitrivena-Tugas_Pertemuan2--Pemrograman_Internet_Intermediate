  ...
  <body class="bg-dark">
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <form action="process_barang.php" method="post" enctype="multipart/form-data">
                <div class="mb-3 col-5">
                    <label for="nama_barang" class="form-label text-white">Nama Barang</label>
                    <input type="text" class="form-control" name="nama_barang" id="nama_barang" required>
                </div>

                <div class="mb-3 col-5">
                    <label for="merek" class="form-label text-white">Merek</label>
                ...
                <div class="mb-5 col-5">
                    ...
                    <button type="submit" name="simpan_barang" class="btn btn-primary">Submit</button>
