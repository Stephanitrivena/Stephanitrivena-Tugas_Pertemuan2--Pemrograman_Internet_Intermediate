        ...
        <div class="container">
            ...
            <form action="process_customer.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 col-5">
                    ...
                    <input type="text" class="form-control" name="id_customer" id="nama_customer" required>
                </div>
                <div class="mb-3 col-5">
                ...
                <div class="mb-3 col-5">
                    ...
                    <button type="submit" name="simpan_customer" class="btn btn-primary">Submit</button>
